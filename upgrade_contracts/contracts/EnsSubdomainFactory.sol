 ...
 * to this deployed contract address. For example, transfer the ownership of "blockchain-whois.eth"
 * so anyone can create subdomains like "aut.blockchain-whois.eth".
 */
contract EnsSubdomainFactory {
  ...
  bytes32 emptyNamehash = 0x00;
	...
	constructor(address _registry, EnsResolver _resolver) public {
		owner = msg.sender;
	...
	/**
	 * @dev Allows to create a subdomain (e.g. "aut.blockchain-whois.eth"),
	 * set its resolver and set its target address
	 * @param _subdomain - sub domain name only e.g. "aut"
	 * @param _domain - domain name e.g. "blockchain-whois"
	 ...
	 */
	function newSubdomain(string memory _subdomain, string memory _domain, string memory _topdomain, address _owner, address _target) public {
	...
	/**
	 * @dev Returns the owner of a domain (e.g. "blockchain-whois.eth"),
	 * @param _domain - domain name e.g. "blockchain-whois"
	...
	/**
	 * @dev Return the owner of a subdomain (e.g. "aut.blockchain-whois.eth"),
	 * @param _subdomain - sub domain name only e.g. "aut"
	 * @param _domain - parent domain name e.g. "blockchain-whois"
	 * @param _topdomain - parent domain name e.g. "eth"
	 */
